...
export function StaffHomePage() {
  ...
  return (
    <div className="flex flex-col gap-6">
      <div>
        <h1 className="font-display text-2xl font-semibold text-white sm:text-[28px]">Today's sessions</h1>
        <p className="mt-1 text-sm text-white/60">Pick a session to open its live queue.</p>
      </div>
      ...
      <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
        {sessions.map((s) => (
          ...
          >
            ...
            <h3 className="font-display text-lg font-semibold text-[var(--color-text)]">{s.doctor.name}</h3>
